...
/**
 * Created by Pratibha on 9/26/2016.
 */
...
public class SQLite extends AppCompatActivity {
    ...
    public void saveSQLite(View v) {
        ...
        if (blog_message != null) {
            SQLStorage dataController = new SQLStorage(getBaseContext());
            dataController.open();
            ...
            if (retValue != -1) {
                ...
                try {
                    ...
                    editor.commit();
                    OutputStreamWriter out = new OutputStreamWriter(openFileOutput(Preference.STORE_PREFERENCES, MODE_APPEND));
